...
public class TempOperations {
    ...
    public ArrayList<CustomerAccount> createBase(){
    ...
    public int findClientByCard(Transaction transaction, ArrayList<CustomerAccount> base) throws CardNotFoundException {
        for (CustomerAccount account : base) {
